...
const SYNONYM_GROUPS = [
  ...
  ['help', 'support', 'contact', 'troubleshoot', 'troubleshooting'],
...
const SECTION_KEYWORDS = {
  ...
  'the-pharmacy-worklist': ['stock', 'catalogue', 'inventory'],
  ...
  'getting-help': ['support', 'contact', 'whatsapp'],
  'common-problems': ['error', 'bug', 'cannot', 'offline', 'missing'],
